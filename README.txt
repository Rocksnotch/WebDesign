-----Updates from P1-----
-Added more text to the home page
-Centered text both vertically and horizontally to the images
-Navbar is the dynamic CSS for this page
...
-----General Notes-----
-Images not visible in Visual Studio due to them being .webp, however .webp loads faster and has a smaller file size, allowing for more images
